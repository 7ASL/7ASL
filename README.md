...
- 🎓 3rd year CS student
- 💻 Focus: web development & embedded systems (hobby)
- 🛠️ Languages: C/C++, Java, Kotlin, JS/TS, Python
- ⚙️ Workflow: Git, Docker, Jira
- 📍 Currently: going deep on the full web stack
...
![WSL](https://img.shields.io/badge/WSL2-0078D4?style=flat-square&logo=windows&logoColor=white)
...
- 🌐 Going deep on the full web stack — HTML/CSS/JS → React → Node.js → Next.js
- 🔷 Learning .NET for backend development
- 🗄️ Working with relational and NoSQL databases (PostgreSQL, MySQL, MongoDB)
- 🔌 Tinkering with microcontrollers and embedded hardware on the side
- 🐳 Docker for clean, reproducible dev environments
- 🤝 Open to collaborate on web or embedded projects
